...
int main() {
    ...
    // Функция malloc используется для выделения области памяти определенного размера.
    // Функция calloc используется для выделения области памяти определенного размера и инициализации ее значений нулями
    ...
    string *str2;
    str2 = (string *) calloc(100, sizeof(int));
